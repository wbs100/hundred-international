                ...
                {breadcrumbs.map((crumb, index) => (
                    <div key={index} className="flex items-center">
                        {crumb.href ? (
                            <a 
                                href={crumb.href}
                                className="text-gray-300 text-black hover:text-orange-400 transition-colors duration-300"
                            >
                                {crumb.label}
                            </a>
                        ) : (
                ...
                <div className="container mx-auto px-6">
                    <div className="max-w-4xl">
                        ...
                        <div className="mb-8 scroll-animate delay-200">
                            {/* <h2 className="text-xl md:text-2xl font-medium text-gray-300 text-black mb-4">
                                NATIVE & <span className="text-orange-400 font-bold">CROSS-PLATFORM</span>
                            </h2> */}
                            <p className="text-lg md:text-xl text-gray-300 text-black max-w-2xl leading-relaxed">
                                {subtitle}
                            </p>
                        </div>
